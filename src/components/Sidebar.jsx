    ...
    <section className="bg-gray-100 h-screen">
      ...
      <article>
        ...
        <div className="flex flex-col">
          <div className="flex px-8 py-2">
            ...
            <h3 className="px-4 cursor-pointer">Buscar</h3>
          </div>
          <div className="flex px-8 py-2">
            <svg
              className="w-6 h-6"
            ...
            <h3 className="px-4 cursor-pointer">Aplicación de Escritorio</h3>
          </div>
        </div>
      ...
      <article>
        ...
        <div className="flex px-8 py-2">
          ...
          />
          <h3 className="flex items-center px-4 cursor-pointer">Invitado</h3>
        </div>
        <div className="flex px-8 py-2">
          <svg
            className="w-6 h-6"
          ...
          <h3 className="px-4 cursor-pointer">Likes</h3>
        </div>
        <hr className="w-9/12 m-auto my-8" />
      </article>
      <article>
        ...
        <div className="flex px-8 py-2">
          ...
          <h3 className="px-4 cursor-pointer">Agregar Lista de Reprodución</h3>
        </div>
        <hr className="w-9/12 m-auto my-8" />
      </article>
    </section>
